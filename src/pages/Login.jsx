            ...
            <div class="bg">
                ...
                <div class="container">
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" class="input" id="email" placeholder="example@gmail.com" maxlength="20" required value={email} onChange={(e) => {
                    ...
                    <div class="rad">
                        <input type="radio" class="radio-button" name="r1" value="Donor" checked={userType === 'Donor'} onChange={handleOptionChange} />
                        <label>DONOR</label>
